#
#  Be sure to run `pod spec lint STSOData.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Stan Stadelman" => "sstadelman@gmail.com" }
  # Or just: s.author    = "sstadelman"
  # s.authors            = { "sstadelman" => "email@address.com" }
  s.social_media_url   = "http://twitter.com/sstadelman"
  ...
  s.source       = { :git => "https://github.com/Oggerschummer/STSOData.git", :tag => "0.1.1" }
